...
var _ = Describe("UAC Controller", func() {
		...
		Context("when the instrument has a CAWI mode", func() {
			...
			Context("when the instrument does exist when getting case ids", func() {
				...
				It("generates and return a bunch of UACs", func() {
					...
					Expect(httpRecorder.Body.String()).To(Equal(`{"125634896985":{"instrument_name":"test123","case_id":"12452","disabled":null,"uac_chunks":{"uac1":"1256","uac2":"3489","uac3":"6985"}}}`))
				})
			})
	...
	Describe("GET /uacs/instrument/:instrumentName", func() {
		...
		Context("When the instrument has UAC codes", func() {
			...
			It("Gets all UACs for an installed instrument", func() {
				Expect(httpRecorder.Code).To(Equal(http.StatusOK))
				Expect(httpRecorder.Body.String()).To(Equal(`{"125634896985":{"instrument_name":"test123","case_id":"12452","disabled":null,"uac_chunks":{"uac1":"1256","uac2":"3489","uac3":"6985"}},"78945612309":{"instrument_name":"test123","case_id":"65858","disabled":null,"uac_chunks":{"uac1":"7894","uac2":"5612","uac3":"309"}}}`))
			})
		})
	...
	Describe("GET /uacs/instrument/:instrumentName/bycaseid", func() {
		...
		It("Gets all UACs for an installed instrument", func() {
			Expect(httpRecorder.Code).To(Equal(http.StatusOK))
			Expect(httpRecorder.Body.String()).To(Equal(`{"12452":{"instrument_name":"test123","case_id":"12452","disabled":null,"uac_chunks":{"uac1":"1256","uac2":"3489","uac3":"6985"},"full_uac":"125634896985"},"65858":{"instrument_name":"test123","case_id":"65858","disabled":null,"uac_chunks":{"uac1":"7894","uac2":"5612","uac3":"309"},"full_uac":"78945612309"}}`))
		})
	})
	...
	Describe("/uacs/uac", func() {
		...
		Context("A valid UAC returns UACInfo for that code", func() {
			...
			It("Gets UAC Info for a valid UAC Code", func() {
				Expect(httpRecorder.Code).To(Equal(http.StatusOK))
				Expect(httpRecorder.Body.String()).To(Equal(`{"instrument_name":"test123","case_id":"12452","disabled":null}`))
			})
		})
